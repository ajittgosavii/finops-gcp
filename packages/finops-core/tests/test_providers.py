...
from finops_core.connectors.demo import COMMITMENT_DISCOUNT, SPOT_DISCOUNT, _share
from finops_core.config import CLOUDS, AppConfig
...
def estate() -> pd.DataFrame:
    from finops_core.connectors.demo import DemoConnector
